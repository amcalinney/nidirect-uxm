...
//address and datepicker lookup
        $(document).ready(function () {
            $('.dropdown-toggle').dropdown();
            $('body').removeClass('no-js');
            $('div#select-address').hide();
            $('button#find-address').click(function () {
                $('div#select-address').fadeIn(800);
            });
            $('div#select-address select').click(function () {
                $('#txt_address1').val('2 Beechwood Gardens');
                $('#txt_towncity').val('Bangor');
                $('#ddl_country').val('1');
                $('#txt_postcode2').val('BT20 3JD');
            });
...
//radio check buttons
$('input[type="radio"]:checked').closest('.form-check-label').addClass('checked')
// set initial state
var $checked = $('input[type="radio"]:checked');
$checked.closest('.form-check-label').addClass('checked');

// update on change
$('input[type="radio"]').change(function() {
  $checked.prop('checked', false).closest('.form-check-label').removeClass('checked');
  $checked = $(this);
  $checked.closest('.form-check-label').addClass('checked');
});

//checkbox
$('input[type="checkbox"]:checked').closest('.form-check-label').addClass('checked')
// set initial state
